...
function checkform(){		
	...
	// let Bday1 = new Date(inputDataUrodzeniaKli.value);
	// let wiek1 = (Date.now()-Bday1)/31557600000;

	let now = Date.now();
  	let cutoffDate = new Date(now - (1000 * 60 * 60 * 24 * 365 * 16)); 

		
    if (inputDataUrodzeniaKli.value < cutoffDate){
